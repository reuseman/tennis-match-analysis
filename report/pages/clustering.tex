...
The clustering algorithm manages to find interesting groupings. Analysing Figure \ref{fig:kmeans_hist_age}, it can be seen that cluster 0 has a lower average age and cluster 1 a higher one. 
